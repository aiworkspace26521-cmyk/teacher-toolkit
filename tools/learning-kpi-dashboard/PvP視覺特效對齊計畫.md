...
| P1-2: 道具特效 | ✅ 已完成 (2026-07-07) — PvP 完整移植 | P1 |
| P1-3: 防禦道具視覺 | ✅ 已完成 (2026-07-07) — 同 P1-2 | P1 |
| P2-1: 天氣特效 | ✅ 已完成 (2026-07-07) — 共享天氣 | P2 |
| P2-2: 燒傷/種子每回合傷害 | ✅ 已完成 (2026-07-07) — HP 動畫 | P2 |
| P2-3: 天氣傷害 | ✅ 已完成 (2026-07-07) — 沙暴/冰雹 | P2 |
| P3-1: Status sfx.hit() 誤用 | ✅ 與 P0-2 一併修復 (2026-07-06) | P3 |
| P3-2: 換人進場動畫 | ✅ 已完成 (2026-07-06) | P3 |
| P3-3: 晴天火系 Flare | ✅ 已完成 (2026-07-07) — 含入天氣系統 | P3 |
...
| Phase 4 | P1-2/P1-3: 道具系統 PvP 移植 | ~40 min |
| Phase 5 | P2-1/P2-3/P3-3: 天氣系統 | ~30 min |
| Phase 6 | P2-2: 狀態傷害視覺 | ~15 min |
| | **總計** | **~145 min** |
