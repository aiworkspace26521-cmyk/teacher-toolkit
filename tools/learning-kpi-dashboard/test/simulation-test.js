...
const POKEMON_SPECIES_TYPES = {
  ...
  "迷你龍":["龍"],"哈克龍":["龍"],"快龍":["龍","飛行"],
  "由基拉":["岩石","地面"],"沙基拉斯":["岩石","地面"],"班基拉斯":["岩石","惡"],
...
const MASTERS_8 = [
  { rank:8, name:"小智", type:"混合", lvBonus:75,
    desc:"阿羅拉冠軍 — 羈絆的王者",
    pokemon:["皮卡丘","耿鬼","蔥遊兵","路卡利歐","鰓魚龍","快龍"] },
  { rank:7, name:"艾莉絲", type:"龍", lvBonus:80,
    desc:"合眾冠軍 — 龍之少女",
    pokemon:["雙斧戰龍","快龍","龍頭地鼠","三首惡龍","赤面龍","電飛鼠"] },
  { rank:6, name:"艾嵐", type:"火", lvBonus:82,
    desc:"卡洛斯優勝 — Mega進化先驅",
    pokemon:["噴火龍","布里卡隆","烏賊王","班基拉斯","瑪狃拉","劈斬司令"] },
  { rank:5, name:"卡露妮", type:"混合", lvBonus:85,
    desc:"卡洛斯冠軍 — 優雅與力量的化身",
    pokemon:["沙奈朵","怪顎龍","冰雪巨龍","南瓜怪人","摔角鷹人","黏美龍"] },
  { rank:4, name:"渡", type:"龍", lvBonus:88,
    desc:"關都/城都冠軍 — 龍之使者",
    pokemon:["快龍","暴鯉龍","三首惡龍","化石翼龍","班基拉斯","暴飛龍"] },
  { rank:3, name:"大吾", type:"鋼", lvBonus:92,
    desc:"豐緣冠軍 — 石之意志",
    pokemon:["巨金怪","大鋼蛇","搖籃百合","太古盔甲","盔甲鳥","波士可多拉"] },
  { rank:2, name:"竹蘭", type:"混合", lvBonus:96,
    desc:"神奧冠軍 — 傳承的意志",
    pokemon:["烈咬陸鯊","花岩怪","羅絲雷朵","波克基斯","海兔獸","美納斯"] },
  { rank:1, name:"丹帝", type:"混合", lvBonus:100,
    desc:"伽勒爾冠軍 — 不敗王者",
