...
const EVO_CHAIN_MAP = {
  ...
  "飛天螳螂":["巨鉗螳螂","劈斧螳螂"],"菊石獸":["多刺菊石獸"],"化石盔":["鐳射盔"],
  "火紅不倒翁":["達摩狒狒"],"搬運小匠":["鐵骨土人","修建老匠"],"螺釘地鼠":["龍頭地鼠"],
  "石丸子":["地幔岩","龐岩怪"],"蓋蓋蟲":["騎士蝸牛"],
  ...
  // Gen1 rare chain
  "迷你龍":["哈克龍","快龍"],"由基拉":["沙基拉斯","班基拉斯"],"寶貝龍":["甲殼龍","暴飛龍"],
