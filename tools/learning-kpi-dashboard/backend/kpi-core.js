...
function _fixEvoNameAfterCap(cleanName, initLv) {
  ...
  // base form is found; compute correct stage at capped level
  var stage = Math.floor(initLv / 15);
  if (stage === 0) {
    // Need to downgrade to base form — preserve type from original cleanName
