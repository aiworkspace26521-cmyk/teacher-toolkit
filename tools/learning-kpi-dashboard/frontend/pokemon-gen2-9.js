...
_addGen(["波克比","波克基古","波克基斯","小火焰猴","猛火猴","烈焰猴","草苗龜","樹林龜","土台龜","波加曼","波皇子","帝王拿波","姆克兒","姆克鳥","姆克鷹","小貓怪","勒克貓","倫琴貓","由克希","艾姆利多","亞克諾姆","帝牙盧卡","帕路奇亞","騎拉帝納","席多藍恩","雷吉奇卡斯","克雷色利亞","達克萊伊","阿爾宙斯","霏歐納","瑪納霏","謝米","盾甲龍","護城龍","頭蓋龍","戰槌龍","泳圈鼬","浮潛鼬","圓法師","音箱蟬","無殼海兔","海兔獸","紫天蝎","龍王蠍","圓陸鯊","尖牙陸鯊","烈咬陸鯊","由基拉","沙基拉","班基拉斯","寶貝龍","甲殼龍","暴飛龍","利歐路","路卡利歐","拉魯拉絲","奇魯莉安","沙奈朵","艾路雷朵","黏黏寶","黏美兒","黏美龍","心鱗寶","鱗甲龍","杖尾鱗甲龍","幼基拉斯","沙基拉斯","多邊獸Ｚ","音箱蟀","倫琴貓","帝王拿波","土台龜","烈焰猴", "波克基斯", "艾路雷朵", "烈咬陸鯊", "暴飛龍", "路卡利歐", "沙奈朵", "班基拉斯"],4);
...
_addGen(["拳拳蛸","八爪武師","毒電嬰","顫弦蠑螈","咬咬龜","暴噬龜","索偵蟲","天罩蟲","以歐歐普","來電汪","逐電犬","愛管侍","稚山雀","藍鴉","鋼鎧鴉","貪心栗鼠","藏飽栗鼠","偷兒狐","狐大盜","淚眼蜥","變澀蜥","千面避役","敲音猴","啪咚猴","轟擂金剛猩","炎兔兒","騰蹴小將","閃焰王牌","列陣兵","啪嚓海膽","冰砌鵝","莫魯貝可","雪吞蟲","雪絨蛾","啃果蟲","蘋裹龍","豐蜜龍","小仙奶","霜奶仙","多龍梅西亞","多龍奇","多龍巴魯托","蒼響","藏瑪然特","無極汰那","熊徒弟","武道熊師","雷吉艾勒奇","雷吉鐸拉戈","雪暴馬","靈幽馬","蕾冠王","薩戮德","伽勒爾喵喵","喵頭目","伽勒爾蛇紋熊","伽勒爾直衝熊","堵攔熊","伽勒爾雙彈瓦斯","伽勒爾大蔥鴨","蔥遊兵","伽勒爾呆呆獸","伽勒爾呆殼獸","伽勒爾呆呆王","伽勒爾火紅不倒翁","伽勒爾達摩狒狒","洗翠霹靂電球","洗翠頑皮雷彈","洗翠索羅亞","洗翠索羅亞克","洗翠卡蒂狗","洗翠風速狗","洗翠勇士雄鷹","洗翠火暴獸","洗翠大劍鬼","洗翠狙射樹梟","洗翠黏美龍","洗翠冰岩怪","洗翠千面避役","劈斧螳螂","月月熊","幽尾玄魚","大狃拉","萬針魚","眷戀雲","以歐路普","蛇紋熊","直衝熊","勇士雄鷹","火暴獸","大劍鬼","狙射樹梟","黏美龍","鋼鎧鴉","千面避役","閃焰王牌","轟擂金剛猩"],8);
