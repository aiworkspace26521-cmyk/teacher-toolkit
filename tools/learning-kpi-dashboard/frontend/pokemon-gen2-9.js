...
var addCommon = [
  ...
  {name:"皮寶寶",evolutions:["皮皮"]},{name:"皮皮",evolutions:["皮可西"]},{name:"呆呆獸",evolutions:["呆殼獸","呆呆王"]},
...
_addGen(["波克比","波克基古","波克基斯","小火焰猴","猛火猴","烈焰猴","草苗龜","樹林龜","土台龜","波加曼","波皇子","帝王拿波","姆克兒","姆克鳥","姆克鷹","小貓怪","勒克貓","倫琴貓","由克希","艾姆利多","亞克諾姆","帝牙盧卡","帕路奇亞","騎拉帝納","席多藍恩","雷吉奇卡斯","克雷色利亞","達克萊伊","阿爾宙斯","霏歐納","瑪納霏","謝米","盾甲龍","護城龍","頭蓋龍","戰槌龍","泳圈鼬","浮潛鼬","圓法師","音箱蟬","無殼海兔","海兔獸","紫天蝎","龍王蠍","圓陸鯊","尖牙陸鯊","烈咬陸鯊","由基拉","沙基拉","班基拉斯","寶貝龍","甲殼龍","暴飛龍","利歐路","路卡利歐","拉魯拉絲","奇魯莉安","沙奈朵","艾路雷朵","黏黏寶","黏美兒","黏美龍","心鱗寶","鱗甲龍","杖尾鱗甲龍","多邊獸Ｚ","音箱蟀","倫琴貓","帝王拿波","土台龜","烈焰猴", "波克基斯", "艾路雷朵", "烈咬陸鯊", "暴飛龍", "路卡利歐", "沙奈朵", "班基拉斯"],4);
