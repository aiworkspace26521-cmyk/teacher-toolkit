...
function inferMoveTypeByName(moveName) {
...
function getMoveSpecV31(moveName) {
  ...
  var inferredType = inferMoveTypeByName(moveName);
...
var allTypes18 = {
  '水': {
    ATK: {
      ...
      T3: ['攀瀑', '濁流', '水之誓約', '水流尾', '生命水滴', '黑霧'],
      T4: ['水炮', '水流尾', '水流裂破', '水之軀', '溶化', '替身'],
      T5: ['水漩渦', '起源波動', '蒸氣爆炸', '海浪滔天', '極致水流', '水之舞']
    },
    SPA: {
      ...
      T5: ['起源波動', '蒸氣爆炸', '水漩渦', '海浪滔天', '水之舞', '極致水流']
    },
    BUF: {
  ...
  '草': {
    ATK: {
      ...
      T5: ['森林詛咒', '創世大地植物', '森林神鞭', '萬物復甦', '絕對吸收', '大爆炸']
    },
    SPA: { T1: ['吸取', '超級吸取', '飛葉快刀', '覺醒力量', '叫聲', '電光一閃'], T2: ['終極吸取', '能量球', '寄生種子', '守住', '光合作用', '高速移動'], T3: ['日光束', '飛葉風暴', '能量球', '青草場地', '替身', '黑霧'], T4: ['瘋狂植物', '日光束', '青草場地', '黑霧', '守住', '替身'], T5: ['森林詛咒', '萬物復甦', '森林神鞭', '創世植物', '睡覺', '大爆炸'] },
    ...
    DIS: { T1: ['催眠粉', '麻痺粉', '芳香粉', '煙幕', '接棒', '哈欠'], T2: ['催眠粉', '寄生種子', '挑釁', '清除之煙', '黑色眼光', '黑霧'], T3: ['麻痺粉', '挑釁', '黑霧', '吹飛', '草葉壓制', '劇毒'], T4: ['劇毒', '催眠粉', '清除之煙', '吼叫', '黑霧', '封印'], T5: ['滅亡之歌', '森林壓制', '絕對封印', '劇毒', '終極壓制', '咆哮'] },
    ULT: { T1: ['聚能', '蓄草', '自然脈衝', '自然共鳴', '蓄力', '衝草'], T2: ['蓄草', '聚能爆發', '自然脈衝', '植物準備', '蓄力', '守住'], T3: ['瘋狂植物', '萬物復甦', '蓄草衝擊', '超自然爆發', '極致草浪', '聚能'], T4: ['萬物復甦', '瘋狂植物', '極致植物爆', '草核共鳴', '終焉之草', '大爆炸'], T5: ['森林神毀滅', '終極植物衝風', '草神神核爆', '森林波濤', '創世草皇點燃', '大爆炸'] }
  },
  '一般': {
    ATK: {
      ...
      T5: ['創世衝擊', '極致破壞光線', '絕對全能', '創世祝福', '萬物歸一', '大爆炸']
    },
    ...
    DIS: { T1: ['哈欠', '煙幕', '叫聲', '搖尾巴', '接棒', '挑釁'], T2: ['哈欠', '挑釁', '清除之煙', '黑色眼光', '黑霧', '煙幕'], T3: ['劇毒', '挑釁', '黑霧', '吹飛', '吼叫', '封印'], T4: ['劇毒', '哈欠', '清除之煙', '吼叫', '黑霧', '封印'], T5: ['滅亡之歌', '全能壓制', '絕對封印', '劇毒', '終極壓制', '咆哮'] },
    ULT: { T1: ['聚能', '蓄力', '全能脈衝', '創世共鳴', '衝能', '守住'], T2: ['蓄力', '聚能爆發', '全能脈衝', '終極準備', '守住', '替身'], T3: ['終極衝擊', '破壞光線', '蓄力衝擊', '超全能爆發', '極致脈衝', '聚能'], T4: ['破壞光線', '終極衝擊', '極致全能爆', '全能共鳴', '終焉之光', '大爆炸'], T5: ['創世毀滅爆發', '終極全能衝風', '創世神核爆', '創世波濤', '創世全能點燃', '大爆炸'] }
  }
};
...
function getPokemonPrimaryType(pkmn) {
  ...
  // 2. 從 POKEMON_SPECIES_TYPES 官方圖鑑查表 (例如: "皮卡丘" -> ["電"])
...
function resolveSkillTreeV31(pkmn) {
  ...
  var lib = TIER_MATRIX_V31[type] || TIER_MATRIX_V31['一般'] || TIER_MATRIX_V31['火'];
...
window.getPokemonPrimaryType = getPokemonPrimaryType;
