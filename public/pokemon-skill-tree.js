...
// ========== ULT 變體招式庫（18屬性 × 5種ULT路線 × T3/T4/T5）==========
// A=制裁(物理型) B=終結(特攻型) C=極致(速攻型) D=裁決(防禦型) E=傳說(傳說型)
var ULT_VARIANTS = {
  "一般":{
    A:["一般·制裁重擊","一般·制裁衝擊","一般·制裁終章"],
    B:["一般·終結波動","一般·終結風暴","一般·終結審判"],
    C:["一般·極致疾風","一般·極致閃擊","一般·極致奧義"],
    D:["一般·裁決壁壘","一般·裁決領域","一般·裁決降臨"],
    E:["一般·傳說覺醒","一般·傳說降臨","一般·傳說永恆"]
  },
  "火":{
    A:["火·制裁烈焰","火·制裁爆炎","火·制裁煉獄"],
    B:["火·終結火球","火·終結火海","火·終結焚天"],
    C:["火·極致火花","火·極致星火","火·極致燎原"],
    D:["火·裁決熔岩","火·裁決火山","火·裁決地核"],
    E:["火·傳說鳳凰","火·傳說炎帝","火·傳說創世焰"]
  },
  "水":{
    A:["水·制裁激流","水·制裁洪流","水·制裁海嘯"],
    B:["水·終結水炮","水·終結漩渦","水·終結深淵"],
    C:["水·極致浪花","水·極致浪潮","水·極致潮汐"],
    D:["水·裁決冰層","水·裁決冰川","水·裁決永凍"],
    E:["水·傳說波塞冬","水·傳說利維坦","水·傳說創世海"]
  },
  "草":{
    A:["草·制裁藤鞭","草·制裁荊棘","草·制裁森林"],
    B:["草·終結種子","草·終結花粉","草·終結綻放"],
    C:["草·極致葉刃","草·極致綠葉","草·極致花海"],
    D:["草·裁決樹皮","草·裁決古木","草·裁決自然"],
    E:["草·傳說世界樹","草·傳說花神","草·傳說創世綠"]
  },
  "電":{
    A:["電·制裁雷電","電·制裁落雷","電·制裁天雷"],
    B:["電·終結電球","電·終結電場","電·終結雷暴"],
    C:["電·極致電光","電·極致閃光","電·極致光速"],
    D:["電·裁決電網","電·裁決電牆","電·裁決雷域"],
    E:["電·傳說宙斯","電·傳說雷神","電·傳說創世雷"]
  },
  "冰":{
    A:["冰·制裁冰錐","冰·制裁冰刃","冰·制裁永冬"],
    B:["冰·終結寒氣","冰·終結暴雪","冰·終結冰河"],
    C:["冰·極致冰晶","冰·極致冰塵","冰·極致雪崩"],
    D:["冰·裁決冰盾","冰·裁決冰堡","冰·裁決極地"],
    E:["冰·傳說斯卡蒂","冰·傳說雪女","冰·傳說創世冰"]
  },
  "格鬥":{
    A:["格鬥·制裁直拳","格鬥·制裁連擊","格鬥·制裁奧義"],
    B:["格鬥·終結氣彈","格鬥·終結波動","格鬥·終結爆裂"],
    C:["格鬥·極致步伐","格鬥·極致閃打","格鬥·極致神速"],
    D:["格鬥·裁決鐵骨","格鬥·裁決金身","格鬥·裁決不壞"],
    E:["格鬥·傳說阿修羅","格鬥·傳說武神","格鬥·傳說創世拳"]
  },
  "毒":{
    A:["毒·制裁毒針","毒·制裁毒刃","毒·制裁劇毒"],
    B:["毒·終結毒霧","毒·終結毒雲","毒·終結瘴氣"],
    C:["毒·極致毒液","毒·極致毒牙","毒·極致毒瀑"],
    D:["毒·裁決毒壁","毒·裁決毒域","毒·裁決毒沼"],
    E:["毒·傳說蛇神","毒·傳說蠍后","毒·傳說創世毒"]
  },
  "地面":{
    A:["地面·制裁震盪","地面·制裁震裂","地面·制裁地震"],
    B:["地面·終結沙暴","地面·終結塵暴","地面·終結荒漠"],
    C:["地面·極致流沙","地面·極致岩刃","地面·極致穿巖"],
    D:["地面·裁決岩壁","地面·裁決大地","地面·裁決核心"],
    E:["地面·傳說蓋亞","地面·傳說泰坦","地面·傳說創世土"]
  },
  "飛行":{
    A:["飛行·制裁羽擊","飛行·制裁風刃","飛行·制裁天翔"],
    B:["飛行·終結氣流","飛行·終結颶風","飛行·終結風暴"],
    C:["飛行·極致輕盈","飛行·極致疾馳","飛行·極致音速"],
    D:["飛行·裁決風牆","飛行·裁決大氣","飛行·裁決天穹"],
    E:["飛行·傳說朱雀","飛行·傳說朱雀","飛行·傳說創世翼"]
  },
  "超能力":{
    A:["超能力·制裁念刀","超能力·制裁念刃","超能力·制裁念核"],
    B:["超能力·終結精神","超能力·終結心靈","超能力·終結意識"],
    C:["超能力·極致瞬間","超能力·極致預知","超能力·極致傳送"],
    D:["超能力·裁決屏障","超能力·裁決結界","超能力·裁決虛空"],
    E:["超能力·傳說超夢","超能力·傳說阿尔","超能力·傳說創世念"]
  },
  "蟲":{
    A:["蟲·制裁蟲咬","蟲·制裁毒刺","蟲·制裁蜂群"],
    B:["蟲·終結蟲絲","蟲·終結蟲網","蟲·終結蟲巢"],
    C:["蟲·極致蟲鸣","蟲·極致蟲翼","蟲·極致蟲潮"],
    D:["蟲·裁決甲殼","蟲·裁決蛹壁","蟲·裁決蟲后"],
    E:["蟲·傳說昆蟲王","蟲·傳說魔蟲","蟲·傳說創世蟲"]
  },
  "岩石":{
    A:["岩石·制裁石刃","岩石·制裁岩崩","岩石·制裁隕星"],
    B:["岩石·終結碎石","岩石·終結塵爆","岩石·終結山崩"],
    C:["岩石·極致岩礫","岩石·極致晶刃","岩石·極致鑽光"],
    D:["岩石·裁決磐石","岩石·裁決山脈","岩石·裁決大地"],
    E:["岩石·傳說巨神兵","岩石·傳說山神","岩石·傳說創世巖"]
  },
  "幽靈":{
    A:["幽靈·制裁鬼爪","幽靈·制裁影刃","幽靈·制裁冥界"],
    B:["幽靈·終結詛咒","幽靈·終結厄運","幽靈·終結深淵"],
    C:["幽靈·極致魅影","幽靈·極致穿梭","幽靈·極致幻境"],
    D:["幽靈·裁決靈盾","幽靈·裁決結界","幽靈·裁決亡域"],
    E:["幽靈·傳說死神","幽靈·傳說鬼王","幽靈·傳說創世冥"]
  },
  "龍":{
    A:["龍·制裁龍爪","龍·制裁龍尾","龍·制裁龍牙"],
    B:["龍·終結龍息","龍·終結龍波","龍·終結龍星"],
    C:["龍·極致龍速","龍·極致龍翼","龍·極致龍馳"],
    D:["龍·裁決龍鱗","龍·裁決龍壁","龍·裁決龍域"],
    E:["龍·傳說奧丁","龍·傳說龍神","龍·傳說創世龍"]
  },
  "惡":{
    A:["惡·制裁暗爪","惡·制裁暗刃","惡·制裁深淵"],
    B:["惡·終結暗球","惡·終結暗渦","惡·終結虛無"],
    C:["惡·極致暗步","惡·極致穿梭","惡·極致影域"],
    D:["惡·裁決暗壁","惡·裁決暗域","惡·裁決深淵"],
    E:["惡·傳說撒旦","惡·傳說魔神","惡·傳說創世暗"]
  },
  "鋼":{
    A:["鋼·制裁鋼拳","鋼·制裁鋼刃","鋼·制裁鋼魂"],
    B:["鋼·終結鋼彈","鋼·終結鋼雨","鋼·終結鋼星"],
    C:["鋼·極致鋼翼","鋼·極致鋼光","鋼·極致鋼速"],
    D:["鋼·裁決鋼壁","鋼·裁決鋼城","鋼·裁決鋼域"],
    E:["鋼·傳說鍛造神","鋼·傳說鋼龍","鋼·傳說創世鋼"]
  },
  "妖精":{
    A:["妖精·制裁妖光","妖精·制裁妖刃","妖精·制裁仙境"],
    B:["妖精·終結妖風","妖精·終結妖氣","妖精·終結魔域"],
    C:["妖精·極致妖精","妖精·極致童話","妖精·極致夢境"],
    D:["妖精·裁決妖盾","妖精·裁決妖壁","妖精·裁決森林"],
    E:["妖精·傳說仙后","妖精·傳說精靈","妖精·傳說創世妖"]
  }
};
...
// ========== Phase 0: TYPE_SPEC_V2 (18 attributes, 98 variants) ==========
const TYPE_SPEC_V2 = {
  "一般": {
    theme: "萬能中庸，招式樸素直接",
    VARIANTS: {
...
// ========== Phase 0: TYPE_T5_SIGNATURES ==========
const TYPE_T5_SIGNATURES = {
...
// ========== Phase 0: TYPE_MOVE_LIBRARY ==========
const TYPE_MOVE_LIBRARY = {
  "火": {
    type_basic_atk:      ["火花"],
    type_basic_spa:      ["火花"],
    type_basic_buf:      ["叫聲"],
  ...
  "草": {
    ...
    type_medium_spa:     ["魔法葉", "能量球"],
    type_strong_atk:     ["木角", "種子炸彈"],
    type_strong_spa:     ["打草結", "日光束"],
    type_top_atk:        ["木槌", "日光刃"],
    type_top_spa:        ["飛葉風暴"],
...
// ULT 變體選擇 - 從 ULT_VARIANTS 查表並回傳完整 T3/T4/T5 路徑
function selectUltVariant(pokemon, type, variantName) {
  ...
  if (!ultMoves || ultMoves.length < 3) {
    ultMoves = [type + "·制裁衝擊", type + "·制裁連擊", type + "·" + (pokemon.baseName || "寶可夢") + "制裁"];
  }
